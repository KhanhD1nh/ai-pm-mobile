          ...
          >
            ...
            <View style={styles.copy}>
              ...
              <View style={styles.meta}>
                ...
                {issue.due_date ? <><Text style={styles.metaDot}>·</Text><Ionicons accessible={false} name="calendar-outline" size={12} color={ui.colors.textMuted} /><Text style={styles.metaText}>{new Date(issue.due_date).toLocaleDateString(locale)}</Text></> : null}
              </View>
            </View>
...
const createStyles = (ui: AppTheme) => StyleSheet.create({
  ...
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'baseline', paddingHorizontal: 1, paddingTop: 14, paddingBottom: 6, backgroundColor: ui.colors.bg },
  ...
  metaText: { color: ui.colors.textMuted, ...ui.typography.caption, fontSize: 11.5 },
