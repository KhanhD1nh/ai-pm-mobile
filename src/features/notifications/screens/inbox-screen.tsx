...
export default function InboxScreen() {
  ...
  const secondaryFilters = NOTIFICATION_FILTERS.filter(
    (item) => !PRIMARY_FILTERS.includes(item),
  );
  ...
  return (
    <Screen scroll={false}>
          ...
          <View style={styles.headerBlock}>
            <View style={styles.appBar}>
              <View style={styles.headingCopy}>
                ...
                <Text style={styles.headingMeta}>
                  {unread.data?.unread ?? 0} {t("inbox.unread")}
                </Text>
              </View>
              <View style={styles.headerActionSafeArea}>
                <GlassIconButton
                  ...
                  disabled={
                    (unread.data?.unread ?? 0) === 0 || markAll.isPending
                  }
            ...
            <View style={styles.filterRow}>
              ...
              <MotionPressable
                accessibilityRole="button"
                accessibilityLabel={
                  language === "vi" ? "Bộ lọc khác" : "More filters"
                }
                accessibilityState={{ selected: secondaryActive }}
                onPress={() => setShowFilters(true)}
                style={[
                  styles.moreFilter,
                  secondaryActive && styles.filterActive,
                ]}
              >
                <Ionicons
                  accessible={false}
        ...
        ListEmptyComponent={
          notifications.isLoading ? (
            <View style={styles.loadingState}>
              <ActivityIndicator color={ui.colors.accentStrong} />
            </View>
      ...
      <BottomSheet
        visible={showFilters}
        title={language === "vi" ? "Bộ lọc thông báo" : "Notification filters"}
...
const createStyles = (ui: AppTheme) =>
  StyleSheet.create({
    ...
    priority: { fontSize: 10, lineHeight: 14, fontWeight: "600" },
    body: {
      color: ui.colors.textSecondary,
      ...ui.typography.body,
      fontSize: 13,
