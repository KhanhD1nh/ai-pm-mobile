...
import { ContentTabs, GlassIconButton, HeaderBackButton } from '@/shared/components/ui/mobile';
...
export function ProjectWorkspaceShell({ children }: PropsWithChildren) {
  ...
  if (project.data?.organization_id && project.data.organization_id !== orgId) return <LoadingScreen />;
