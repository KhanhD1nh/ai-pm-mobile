...
export default function MoreScreen() {
  ...
  const currentThemeLabel =
    themeOptions.find((x) => x.value === themePreference)?.label ??
    t("common.system");
    ...
    <Screen title={t("more.title")}>
      ...
      <ListGroup>
        <ListRow
          ...
          onPress={() => setPreferenceSheet("theme")}
        />
        <ListRow
          icon="language-outline"
          label={t("more.language")}
          value={currentLanguageLabel}
          onPress={() => setPreferenceSheet("language")}
        />
        {Platform.OS === "ios" ? (
          <ListRow
            icon="water-outline"
            ...
            detail={
              language === "vi"
                ? "Theo Cài đặt > Màn hình & Độ sáng > Liquid Glass"
                : "Follows Settings > Display & Brightness > Liquid Glass"
            }
            value={language === "vi" ? "Hệ thống" : "System"}
          />
        ) : null}
        <ListRow
          icon="phone-portrait-outline"
          label={t("more.mobileSettings")}
          detail={t("more.mobileSettingsDetail")}
          onPress={() => router.push("/settings/mobile")}
        />
      </ListGroup>

      <SectionLabel
        text={language === "vi" ? "Workspace" : "Workspace"}
        ui={ui}
      />
      <ListGroup>
      ...
      <ListGroup>
        <ListRow
          ...
          icon="search-outline"
          label={t("more.search")}
          detail={t("more.searchDetail")}
          onPress={() => router.push("/search")}
        />
        <ListRow
          icon="sparkles-outline"
          label={t("more.agents")}
          detail={t("more.agentsDetail")}
          onPress={() => router.push("/agents")}
        />
      </ListGroup>

      <SectionLabel
        text={language === "vi" ? "Quản trị" : "Administration"}
        ui={ui}
      />
      <ListGroup>
        <ListRow
          first
          icon="business-outline"
          label={t("more.organization")}
          detail={t("more.organizationDetail")}
          onPress={() => router.push("/settings/organization")}
        />
        <ListRow
          icon="wallet-outline"
          label={t("more.aiBudget")}
          detail={t("more.aiBudgetDetail")}
          onPress={() => router.push("/settings/ai-budget")}
        />
        {isSystemOwner ? (
          <ListRow
            icon="people-outline"
            label={t("more.systemUsers")}
            detail={t("more.systemUsersDetail")}
        ...
        {isSystemOwner ? (
          <ListRow
            ...
            detail={
              language === "vi"
                ? "Token, trạng thái và webhook hệ thống"
                : "System bot token, status, and webhook"
            }
            onPress={() => router.push("/settings/telegram-admin" as never)}
          />
        ) : null}
      </ListGroup>
