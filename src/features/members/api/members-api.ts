...
export const membersApi = {
  ...
  addBatch: (projectId: string, userIds: string[], role = 'MEMBER') => request<{ added: ProjectMember[]; skippedCount: number }>(`/projects/${projectId}/members/batch`, { method: 'POST', body: JSON.stringify({ userIds, role }) }),
