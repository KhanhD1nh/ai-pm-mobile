...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  vi: {
    ...
    'login.signInBody': 'Đăng nhập để tiếp tục quản lý dự án, công việc và AI agents.',
  ...
  en: {
    ...
    'login.signInBody': 'Sign in to continue managing projects, work and AI agents.',
...
export const AppPreferencesContext = createContext<AppPreferencesContextValue>(defaultValue);
