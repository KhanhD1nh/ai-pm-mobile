...
export default function TabsLayout() {
  ...
  return (
    <NativeTabs
      ...
      iconColor={{ default: ui.colors.textSecondary, selected: ui.colors.accentStrong }}
      minimizeBehavior="never"
      unstable_nativeProps={{ rejectStaleNavStateUpdates: true }}
    >
      <NativeTabs.Trigger name="(home)" testID="native-tab-home" accessibilityLabel={t('nav.home')} contentStyle={{ backgroundColor: ui.colors.bg }}>
        <NativeTabs.Trigger.Icon sf={{ default: 'house', selected: 'house.fill' }} md={{ default: 'home', selected: 'home' }} />
        <NativeTabs.Trigger.Label hidden>{t('nav.home')}</NativeTabs.Trigger.Label>
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="(projects)" testID="native-tab-projects" accessibilityLabel={t('nav.projects')} contentStyle={{ backgroundColor: ui.colors.bg }}>
        <NativeTabs.Trigger.Icon sf={{ default: 'folder', selected: 'folder.fill' }} md={{ default: 'folder', selected: 'folder' }} />
        <NativeTabs.Trigger.Label hidden>{t('nav.projects')}</NativeTabs.Trigger.Label>
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="(create)" testID="native-tab-create" accessibilityLabel={language === 'vi' ? 'Tạo công việc' : 'Create task'} contentStyle={{ backgroundColor: ui.colors.bg }}>
        <NativeTabs.Trigger.Icon sf="plus" md="add" />
        <NativeTabs.Trigger.Label hidden>{language === 'vi' ? 'Tạo' : 'Create'}</NativeTabs.Trigger.Label>
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="(inbox)" testID="native-tab-inbox" accessibilityLabel={t('nav.inbox')} contentStyle={{ backgroundColor: ui.colors.bg }}>
        ...
        <NativeTabs.Trigger.Label hidden>{t('nav.inbox')}</NativeTabs.Trigger.Label>
      </NativeTabs.Trigger>

      <NativeTabs.Trigger name="(more)" testID="native-tab-more" accessibilityLabel={t('nav.more')} contentStyle={{ backgroundColor: ui.colors.bg }}>
        ...
        <NativeTabs.Trigger.Label hidden>{t('nav.more')}</NativeTabs.Trigger.Label>
      </NativeTabs.Trigger>
    </NativeTabs>
  );
}
